...
<body>
    ...
    a.href = url;
    a.download = `resultats_election_${new Date().toISOString().split('T')[0]}.html`;
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    window.URL.revokeObjectURL(url);
    
    alert('Les résultats ont été téléchargés avec succès!\nOuvrez le fichier HTML dans votre navigateur ou convertissez-le en PDF.');
  };
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Visualisez et publiez les résultats des élections</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mb-6">
          ...
          >
            <option value="election-1">Élection Présidentielle 2024</option>
          </select>
        </Card>
        ...
        {selectedElection ? (
          <>
            ...
            <div className="grid grid-cols-4 gap-6 mb-6">
              ...
              <Card>
                ...
                <Badge variant="success" className="text-lg px-3 py-1">Ouverte</Badge>
              </Card>
            </div>
            ...
            <Card className="bg-yellow-50 border-yellow-200">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-yellow-900 mb-1">Information</h4>
                  <p className="text-sm text-yellow-800">
                    Aucune élection fermée disponible. Seules les élections terminées peuvent afficher des résultats finaux.
                  </p>
                </div>
              </div>
            </Card>
          ...
          <Card className="text-center py-12">
            ...
            <p className="text-gray-600">
              Sélectionnez une élection pour voir les résultats
            </p>
          </Card>
        )}
      </div>
